function plotMap(resultsArray, myLat, myLon) {

    console.log(L);

    console.log("we are in plotmap");

    let map = L.map('map').setView([myLat, myLon], 14);
    ...
    console.log("plotMap resultsArray: ", resultsArray);
